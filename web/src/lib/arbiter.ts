...
IMPORTANT: All three responses were generated by AI models that had LIVE WEB SEARCH access. Any specific facts, figures, dates, prices, or data points in the responses come from real-time web searches performed moments ago. You MUST treat this data as authoritative and current. Do NOT add disclaimers about lacking real-time data, being unable to access current information, or having a knowledge cutoff. The data in the responses IS current.
...
Return your analysis as JSON with exactly these keys:
{
  ...
  "synthesis": "A comprehensive, synthesised answer that faithfully incorporates the specific facts, data, and findings from the three responses. Include concrete details (numbers, dates, sources) from the responses. NEVER say you lack access to real-time data — the responses already contain it."
}
